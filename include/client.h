...
//client derives server methods
//client maintains the list of all the peers connected to it.
private: 
	vector <host_info> connected_list;

//Used to handle more than one download requests to same peer, 
//if one download is on then request is put into this buffer
//And after the download is complete requets will be sent to client.
